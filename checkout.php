...
<form name="checkout_confirmation" id="checkout_confirmation"
	action="<?php echo $form_action_url;?>" method="post">
	...
	<center>
		...
		<?php require(DIR_WS_INCLUDES . 'header.php'); ?>
			...
			<table border="0" width="100%" cellspacing="3" cellpadding="3">
				<tr>
					<td width="<?php echo BOX_WIDTH; ?>" valign="top"><div id='leftlll'>
					...
					<td width="100%" valign="top">
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td colspan=""><?php echo tep_draw_separator('pixel_black.gif', '100%', '1'); ?>
								</td>
							</tr>
							<tr height="30">
								<td></td>
							...
							<?php if (!tep_session_is_registered('customer_id')) { ?>
							<tr>
								<td class="main" colspan="2"><b><?php echo TEXT_RETURNING_CUSTOMER; ?>
								</b></td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php echo tep_draw_form('login', tep_href_link(FILENAME_CHECKOUT, 'action=process', 'SSL')); ?>
									<table border="0" width="100%" cellspacing="0" cellpadding="2"
										...
										<tr>
											...
											<td class="main"><?php echo tep_draw_input_field('email_address'); ?>
											</td>
											<td align=""><?php echo tep_image_submit('button_sign_in1.gif', IMAGE_BUTTON_LOGIN); ?>
											</td>
										</tr>
										<tr>
											<td class="main"><b><?php echo ENTRY_PASSWORD; ?> </b></td>
											<td class="main"><?php echo tep_draw_password_field('password'); ?>
											</td>
											<td class="smallText" colspan=""><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?>
											</td>
										</tr>
							...
							<tr>
								<td class="main" style="color: red;"><b><?php echo TITLE_NEW_CUSTOMER; ?>
								</b></td>
							</tr>
								...
								<td>
									...
									?>
										...
										<tr>
											...
											<td class="main"><?php echo tep_draw_password_field('new_password') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_TEXT . '</span>': ''); ?>
											</td>
										</tr>
										<tr>
							...
							<tr>
								<td><table border="0" width="100%" cellspacing="0"
										cellpadding="2">
										<tr>
											<td class="main"><b><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?>
											</b></td>
										</tr>
									</table></td>
							</tr>
										...
										<tr class="infoBoxContents">
											<td><table border="0" width="100%" cellspacing="0"
													...
													<tr>
														...
														<td class="main" width="50%" valign="top"><?php echo TEXT_SELECT_OTHER_PAYMENT_DESTINATION; ?>
														</td>
														<td class="main" width="50%" valign="top" align="right"><?php echo '<b>' . TITLE_PLEASE_SELECT . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_east_south.gif'); ?>
														</td>
													...
													<tr>
														...
														<td colspan="3"><table border="0" width="100%"
																...
																<td class="main" colspan="2"><b><?php echo $addresses['firstname'] . ' ' . $addresses['lastname']; ?>
																</b></td>
																<td class="main" align="right"><?php echo tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $billto)); ?>
																</td>
																...
																<tr>
																	...
																	<td colspan="3"><table border="0" cellspacing="0"
																			...
																			<tr>
																				...
																				<td class="main"><?php echo tep_address_format($format_id, $addresses, true, ' ', ', '); ?>
																				</td>
							...
							<tr class="infoBoxContents">
								<td>
									...
									<table border="0" width="100%" cellspacing="0" cellpadding="2">
										<tr class="infoBoxContents">
											<td class="main"><?PHP echo tep_draw_checkbox_field('bill_new','','','onclick="toggle_ship_new(\'bill\');" id="bill_new"');?><b><?php echo TITLE_NEW_BILLING_ADDRESS; ?>
											</b></td>
										</tr>
									</table>
								</td>
							...
							<?php } ?>
								<td>
									...
									<table border="0" width="100%" cellspacing="0" cellpadding="2">
										<tr>
											<td
												class="main <?php if (tep_session_is_registered('customer_id')) echo "bill_address_show";?>"><b><?php echo TITLE_BILLING_ADDRESS; ?>
											</b></td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td>
									...
									<table border="0" width="100%" cellspacing="0" cellpadding="2">
										...
										<tr
											class="infoBoxContents <?php if (tep_session_is_registered('customer_id')) echo "bill_address_show";?>">
											<td>

												<table border="0" width="100%" cellspacing="0"
													cellpadding="2">
													<tr>
														<td><?php require(DIR_WS_MODULES . 'checkout_new_address.php');//require(DIR_WS_MODULES . 'checkout_billing_address.php'); ?>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr class="infoBoxContents">
											<td class="main" style="display: none"><?PHP 
										...
										<tr>
											<td><table border="0" width="100%" cellspacing="0"
													cellpadding="2">
													<tr>
														<td class="main address_shipping_new_onpage"><b><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?>
														</b></td>
													</tr>
												</table></td>
										</tr>
													...
													<tr class="infoBoxContents address_shipping_new_onpage">
														<td><table border="0" width="100%" cellspacing="0"
																...
																<tr>
																	...
																	<td class="main" width="50%" valign="top"><?php echo TEXT_SELECT_OTHER_SHIPPING_DESTINATION; ?>
																	</td>
																	<td class="main" width="50%" valign="top" align="right"><?php echo '<b>' . TITLE_PLEASE_SELECT . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_east_south.gif'); ?>
																	</td>
																...
																<tr>
																	...
																	<td colspan="2"><table border="0" width="100%"
																			...
																			<td class="main" colspan="2"><b><?php echo tep_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?>
																			</b></td>
																			<td class="main" align="right"><?php echo tep_draw_radio_field('ship_address', $addresses['address_book_id'], ($addresses['address_book_id'] == $sendto)); ?>
																			</td>
										...
										<tr>
											<td>
												<table border="0" width="100%" cellspacing="0"
													cellpadding="2">
													<tr class="infoBoxContents">
														<td class="main address_shipping_new_onpage"><?PHP echo tep_draw_checkbox_field('ship_new','','','onclick="toggle_ship_new(\'ship\');" id="ship_new"');?><b><?php echo TITLE_NEW_SHIPPING_ADDRESS; ?>
														</b></td>
													</tr>
												</table>
											</td>
										...
										<?php } ?>
										<tr>
											<td width="10" class="main ship_address_show"><b><?php echo TITLE_SHIPPING_ADDRESS; ?>
											</b></td>
										</tr>
										...
										<tr class="infoBoxContents ship_address_show">
											<td>
												...
												<table border="0" width="100%" cellspacing="0"
													cellpadding="2">
													<tr>
														<td><?php require(DIR_WS_MODULES . 'checkout_shipping_address.php'); ?>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr style="display: none">
											<td><table border="0" width="100%" cellspacing="0"
													cellpadding="2">
													<tr>
														<td class="main"><b><?php echo TABLE_HEADING_SHIPPING_METHOD; ?>
														</b></td>
													</tr>
												</table></td>
										</tr>
													...
													<tr class="infoBoxContents">
														<td><table border="0" width="100%" cellspacing="0"
																...
																<tr>
																	...
																	<td class="main" width="50%" valign="top"><?php echo TEXT_CHOOSE_SHIPPING_METHOD; ?>
																	</td>
																	<td class="main" width="50%" valign="top" align="right"><?php echo '<b>' . TITLE_PLEASE_SELECT . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_east_south.gif'); ?>
																	</td>
																	<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?>
																...
																<tr>
																	...
																	<td class="main" width="100%" colspan="2"><?php echo TEXT_ENTER_SHIPPING_INFORMATION; ?>
																	</td>
																	<td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?>
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td colspan="2" width="100%"><table border="0"
																			...
																			<tr id="defaultSelected" class="moduleRowSelected"
																				...
																				<td class="main" width="100%"><?php echo sprintf(FREE_SHIPPING_DESCRIPTION, $currencies->format(MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER)) . tep_draw_hidden_field('shipping', 'free_free'); ?>
																				</td>
																				<td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?>
																				</td>
																			</tr>
																...
																<tr style="display: none">
																	...
																	<td colspan="2"><table border="0" width="100%"
																			...
																			<tr>
																				...
																				<td class="main" colspan="3"><b><?php echo $quotes[$i]['module']; ?>
																			...
																			if ( ($n > 1) || ($n2 > 1) ) {
																				?>
																			<td class="main"><?php echo $currencies->format(tep_add_tax($quotes[$i]['methods'][$j]['cost'], (isset($quotes[$i]['tax']) ? $quotes[$i]['tax'] : 0))); ?>
																			</td>
																			<td class="main" align="right"><?php echo tep_draw_radio_field('shipping', $quotes[$i]['id'] . '_' . $quotes[$i]['methods'][$j]['id'], $checked); ?>
																			</td>
																			<?php
																			} else {
																				?>
																			<td class="main" align="right" colspan="2"><?php echo $currencies->format(tep_add_tax($quotes[$i]['methods'][$j]['cost'], $quotes[$i]['tax'])) . tep_draw_hidden_field('shipping', $quotes[$i]['id'] . '_' . $quotes[$i]['methods'][$j]['id']); ?>
																			</td>
																			<?php
																			}
																			?>
										...
										<tr>
											<td width="10" class="main"><b><?php echo TITLE_PAYMENT_METHOD; ?>
											</b></td>
										</tr>
										<tr>
											<td><?php // tep_address_label($customer_id, $customer_default_address_id, true, ' ', '<br>'); ?>
											</td>
										</tr>
										<tr class="infoBoxContents">
											<td><table border="0" width="100%" cellspacing="0"
													...
													<tr>
														...
														<td class="main" width="50%" valign="top"><?php echo TEXT_SELECT_PAYMENT_METHOD; ?>
														</td>
														<td class="main" width="50%" valign="top" align="right"><b><?php echo TITLE_PLEASE_SELECT; ?>
														</b><br> <?php echo tep_image(DIR_WS_IMAGES . 'arrow_east_south.gif'); ?>
														</td>
													...
													<tr>
														...
														<td class="main" width="100%" colspan="2"><?php echo TEXT_ENTER_PAYMENT_INFORMATION; ?>
														</td>
													...
													<tr>
														...
														<td colspan="2"><table border="0" width="100%"
																...
																<tr>
																	...
																	<td class="main" colspan="4"><?php echo $selection[$i]['error']; ?>
																	</td>
																...
																<tr>
																	...
																	<td colspan="4"><table border="0" cellspacing="0"
																			cellpadding="2">
																			<?php
																			...
																			<tr>
																				...
																				<td class="main"><?php echo $selection[$i]['fields'][$j]['title']; ?>
																				</td>

																				<td class="main"><?php echo $selection[$i]['fields'][$j]['field']; ?>
																				</td>
										...
										<tr>
											<td
												width="<?php echo (($sendto != false) ? '70%' : '100%'); ?>"
												valign="top" class="main"><table border="0" width="100%"
													...
													<tr>
														<td><table border="0" width="100%" cellspacing="0"
																...
																if (sizeof($order->info['tax_groups']) > 1) {
																	?>
																<tr>
																	<td class="main" colspan="2"><?php echo '<b>' . HEADING_PRODUCTS . '</b> <a href="' . tep_href_link(FILENAME_SHOPPING_CART) . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?>
																	</td>
																	<td class="smallText" align="right"><b><?php echo HEADING_TAX; ?>
																	</b></td>
																	<td class="smallText" align="right"><b><?php echo HEADING_TOTAL; ?>
																	</b></td>
																</tr>
																<?php
																} else {
																	?>
																<tr>
																	<td class="main" colspan="3"><?php echo '<b>' . HEADING_PRODUCTS . '</b> <a href="' . tep_href_link(FILENAME_SHOPPING_CART) . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?>
																	</td>
																</tr>
																<?php
																}
         ...
         '          </tr>' . "\n";
															...
															<table>
																...
																<tr>
																	...
																	<td class="infoBox" colspan="2"><?php 
																		...
																		<table cellspacing="0" cellpadding="0" border="0">
																			<tr>
																				<td width="80%" align="right"
																					class="cart_total_left" nowrap><strong><?php echo SUB_TITLE_SUB_TOTAL; ?>
																				</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																			...
																			<tr>
																				<td width="80%" align="right"
																					class="cart_total_left" nowrap><strong><?php echo $discount['description']; ?>
																				</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																				<td width="20%" align="center"
																					class="cart_total_right"><span
																			...
																			<tr>
																				<td width="80%" align="right"
																					class="cart_total_left" nowrap><strong><?php echo SUB_TITLE_NB_PRODUCTS_DISCOUNT; ?>
																				</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																				<td width="20%" align="center"
																					class="cart_total_right"><span
																			...
																			<tr>
																				<td width="80%" align="right"
																					class="cart_total_left" nowrap><strong><?php echo SUB_TITLE_EASY_DISCOUNT; ?>
																				</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																				<td width="20%" align="center"
																					class="cart_total_right"><span
																			...
																			<tr>
																				<td width="80%" align="right"
																					class="cart_total_left" nowrap><strong><?php echo SUB_TITLE_FRAIS_PORT; ?>
																				</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																				<td width="20%" align="center"
																					class="cart_total_right"><span
																			...
																			<tr>
																				...
																				<td width="80%" align="right"
																					class="cart_total_left" nowrap><strong><?php echo SUB_TITLE_TOTAL; ?>
																				</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																				<td width="20%" align="center"
																					class="cart_total_right"><span id="order_total"
																					class="productSpecialPrice"><?php echo $currencies->format($total_cart <= 0 ? 0 : $total_cart);?>
																				</span>
																				</td>
																			</tr>
																		</table>
													...
													<tr>
														<td width="70%" valign="top" align="left"><table
