...
define('STR_GIFT_CHOOSE', '<script type="text/javascript">document.write(\'<br /><br />Vous préférez un autre cadeau ?<br /><a href="'.tep_href_link(FILENAME_SHOPPING_CART).'#" onclick="document.getElementById(\\\'popup\\\').style.display = \\\'block\\\'">Cliquez ici !</a>\');</script>');
define('CART_MAX_AMOUNT_REACHED', 'Par mesure de sécurité, le montant maximum d\'une commande est limitée à 300€');
...
define('PROMO_GIFT_FOR_3', '<ul class="promo_nb promo_nb3" id="promo_nb1">Ajoutez un article et obtenez un deuxième cadeau supplémentaire</ul>');
...
<tr class="header" style="font-weight:bold;">
  <td>Nbr produits<br />achetés</td><td>Frais de port</td><td>Réduction<br />immédiate</td>
</tr>%s</table>
');

define('SPECIAL_PROMO1', 'Achetez 2 articles et ne payez que 7EUR de frais de port.');
define('SPECIAL_PROMO2', 'Pour 3 produits achetés, frais de port offert !');
