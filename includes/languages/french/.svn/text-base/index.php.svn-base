...
Bienvenue au royaume des secrets des parfums à petits prix !

Baladez vous dans la parfumerie des marques <span class="text_rose">la moins chère de France !</span>
N’achetez plus sans comparer !<span class="text_rose"> Nous remboursons la différence !</span>

« <a class="text_rose" href="'.tep_href_link(FILENAME_ADVANTAGES).'">Découvrez Nos avantages</a> »

- <span class="text_rose">20000 parfums et produits de beauté</span> en ce moment sur le site
- 500 marques a -40%, -50%, -70%
- 2 articles achetés = 2 cadeaux offerts
- Tous les produits en ligne sont en <span class="text_rose">Stock</span>
- <span class="text_rose">Satisfait ou remboursé</span> 30 jours
- Paiement <span class="text_rose">sécurisé</span>
- Service Client : <span class="text_rose">0970 465 068</span> (6 jours/7)');
//- 3€, 8€, <span class="text_rose">15€ de réduction</span> offerts
?>
