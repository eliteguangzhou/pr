...
define('EMAIL_TEXT_ORDER_NUMBER', 'Les vacances approchent, nous vous invitons &agrave; suivre l\'état de livraison de votre colis via le tracking mentionné sur www.bpostinternational.com, en cas d\'absence, le colis reste en poste pendant une période aléatoire de 5 &agrave; 15 jours, au dela de ce délai, votre colis nous sera retourné.<br />
Vous pouvez donner procuration &agrave; un ami ou &agrave; un voisin avec la copie de votre pièce d\'identité pour éviter que votre colis nous soit retourné.<br />
'.EMAIL_SEPARATOR."\n".'Numéro de commande :');
...
Si votre commande ne comporte aucune anomalie, vos produits vous seront livrés dans 12 jours.
<br /><br />
Les vacances approchent, nous vous invitons &agrave; suivre l\'état de livraison de votre colis via le tracking mentionné sur www.bpostinternational.com, en cas d absence, le colis reste en poste pendant une période aléatoire de 5 &agrave; 15 jours, au dela de ce délai, votre colis nous sera retourné.<br />
Vous pouvez donner procuration &agrave; un ami ou &agrave; un voisin avec la copie de votre pièce d\'identité pour éviter que votre colis nous soit retourné.');
...
Nous sommes heureux de vous faire parvenir le code de réduction suivant : "%s" d\'une valeur de %s valable %s mois suite &agrave; la commande de votre %sfilleul %s.

Vous pouvez accéder &agrave; la liste de vos réductions en vous connectant sur notre site et en utilisant le lien suivant :
...
Suite &agrave; votre commande, vos amis peuvent gr&agrave;ce &agrave; vous bénéficier d\'une réduction de %s.

Cliquez sans plus attendre sur le lien suivant pour envoyer le bon de réduction &agrave; vos amis :
